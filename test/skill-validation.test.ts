...
describe('SKILL.md browser alias extraction', () => {
  test('all browser alias commands in SKILL.md are parseable', () => {
    const result = validateSkill(path.join(ROOT, 'SKILL.md'));
    expect(result.invalid).toHaveLength(0);
    expect(result.valid.length).toBeGreaterThan(0);
  });

  test('all browser alias commands in browse/SKILL.md are parseable', () => {
    const result = validateSkill(path.join(ROOT, 'browse', 'SKILL.md'));
    expect(result.invalid).toHaveLength(0);
    expect(result.valid.length).toBeGreaterThan(0);
  });

  test('all browser alias commands in qa/SKILL.md are parseable', () => {
  ...
  test('all browser alias commands in qa-report/SKILL.md are parseable', () => {
  ...
  test('all browser alias commands in plan-design-review/SKILL.md are parseable', () => {
  ...
  test('all browser alias commands in design-review/SKILL.md are parseable', () => {
  ...
  test('all browser alias commands in design-consultation/SKILL.md are parseable', () => {
...
describe('Migration guardrails', () => {
  test('generated SKILL.md files no longer contain $B aliases', () => {
    const skills = [
      'SKILL.md',
      'browse/SKILL.md',
      'qa/SKILL.md',
  ...
  test('gen-skill-docs no longer imports browse/src modules', () => {
    const content = fs.readFileSync(path.join(ROOT, 'scripts', 'gen-skill-docs.ts'), 'utf-8');
    expect(content).not.toContain("../browse/src/commands");
    expect(content).not.toContain("../browse/src/snapshot");
  });
});
...
describe('Planted-bug fixture validation', () => {
  ...
  test('qa-eval.html contains the planted bugs', () => {
    const html = fs.readFileSync(path.join(ROOT, 'test', 'fixtures', 'browser', 'qa-eval.html'), 'utf-8');
    // BUG 1: broken link
